    ...
    <div className="min-h-screen flex items-center justify-center bg-[#5bb3ff]">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md border-4 border-[#3a8ec4]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-gray-700 text-sm font-bold mb-2 uppercase">Seu Nome</label>
            <input 
              type="text" 
              value={name}
          ...
          <div>
            <label className="block text-gray-700 text-sm font-bold mb-2 uppercase">Senha Secreta</label>
            <input 
              type="password" 
              value={password}
          ...
          <button 
            type="submit" 
            className="w-full bg-[#2ecc71] hover:bg-[#27ae60] text-white font-bold py-3 px-4 rounded-lg border-b-4 border-[#1e8449] active:border-b-0 active:translate-y-1 transition-all uppercase text-lg mt-4"
          >
            Descobrir Ilha
          </button>
        </form>
        ...
        <p className="text-center mt-6 text-gray-600">
          Já possui uma ilha?{" "}
          <Link href="/login" className="text-[#3498db] hover:text-[#2980b9] font-bold">
            Entrar
          </Link>
        </p>
      </div>
